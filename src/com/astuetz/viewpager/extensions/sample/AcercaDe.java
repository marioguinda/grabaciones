...
public class AcercaDe extends DialogFragment {
	...
	public class ContactPagerAdapter extends PagerAdapter implements IconTabProvider {
		...
		private final int[] ICONS = { R.drawable.cara_nazas, R.drawable.cara_vicase,
				R.drawable.cara_eduleven, R.drawable.cara_sifilitico };
		...
		public Object instantiateItem(ViewGroup container, int position) {
			...
			if(position==0){
				v.setText("\"Hola soy Nazas\"");
			}
			else if(position==1){
				v.setText("... y yo vicase...");;
			}
